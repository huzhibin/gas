...
@Component({
  selector: 'app-bar-alert-charts',
  templateUrl: './bar-alert-charts.component.html',
  styleUrls: ['./bar-alert-charts.component.css'],
  providers: [BigDataService]
})
  
export class BarAlertChartsComponent implements OnInit {
  myChart: any;
  option: any=null;
