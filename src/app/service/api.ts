...
'AddCompanyUrl': guotao + 'basicInformation/insertCompany.do',//增加企业信息
'UpdateCompanyUrl':guotao+'',//更新企业信息
'DeleteCompanyUrl':guotao+'',//删除企业信息
/**
* 站点信息
*/
'getGasStationleUrl': guotao + 'basicInformation/selectGasStationAll.do',//查询站点信息
'AddStoreUrl': guotao + 'basicInformation/insertGasStation.do',//添加站点信息
...
* 
*/
'getDeliverUrl':guotao+'positionManagement/track/searchInformationById.do', //获取配送员位置
